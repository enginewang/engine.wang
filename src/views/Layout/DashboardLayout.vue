    ...
    <side-bar>
      ...
      <template slot="links-after">
        ...
        <b-nav class="navbar-nav mb-md-3">
          <b-nav-item
               href="http://127.0.0.1:8080/learning-lab/bootstrap-vue/quick-start/argon-dashboard"
               >
              <i class="ni ni-spaceship"></i>
              <b-nav-text class="p-0">Getting started</b-nav-text>
          </b-nav-item>
          <b-nav-item href="http://127.0.0.1:8080/learning-lab/bootstrap-vue/colors/argon-dashboard">
              <i class="ni ni-palette"></i>
              <b-nav-text class="p-0">Foundation</b-nav-text>
          </b-nav-item>
          <b-nav-item href="http://127.0.0.1:8080/learning-lab/bootstrap-vue/avatar/argon-dashboard">
              <i class="ni ni-ui-04"></i>
              <b-nav-text class="p-0">Components</b-nav-text>
          </b-nav-item>
          <b-nav-item href="http://127.0.0.1:8080/learning-lab/bootstrap-vue/charts/argon-dashboard">
